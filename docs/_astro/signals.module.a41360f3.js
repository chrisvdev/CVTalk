import { l as u, t as ni, b as ri } from "./client.18f8eed9.js";
var S,
  v,
  N,
  P,
...
function oi(t, i) {
  var n = K(S++, 3);
  !u.__s && M(n.__H, i) && ((n.__ = t), (n.i = i), v.__H.__h.push(n));
}
function L(t) {
  return (
    (F = 5),
...
function H(t, i) {
  var n = K(S++, 7);
  return M(n.__H, i) ? ((n.__V = t()), (n.i = i), (n.__h = t), n.__V) : n.__;
}
function fi() {
  for (var t; (t = I.shift()); )
    if (t.__P && t.__H)
  ...
  (u.__r = function (t) {
    ...
    i &&
      (N === v
        ...
        : (i.__h.forEach(b), i.__h.forEach(O), (i.__h = []), (S = 0))),
      (N = v);
  }),
  (u.diffed = function (t) {
    G && G(t);
    ...
    i &&
      i.__H &&
      (i.__H.__h.length &&
        ((I.push(i) !== 1 && P === u.requestAnimationFrame) ||
          ((P = u.requestAnimationFrame) || ei)(fi)),
...
function ei(t) {
  var i,
    n = function () {
      clearTimeout(r), D && cancelAnimationFrame(i), setTimeout(t);
    },
    r = setTimeout(n, 100);
  D && (i = requestAnimationFrame(n));
}
function b(t) {
  var i = v,
    n = t.__c;
...
function E() {
  if (h > 1) h--;
    ...
    for (var t, i = !1; p !== void 0; ) {
      var n = p;
      for (p = void 0, j++; n !== void 0; ) {
        var r = n.o;
        if (((n.o = void 0), (n.f &= -3), !(8 & n.f) && W(n)))
          try {
            n.c();
          } catch (f) {
            i || ((t = f), (i = !0));
...
(c.prototype = new s()).h = function () {
  ...
  if (((this.g = g), (this.f |= 1), this.i > 0 && !W(this)))
    return (this.f &= -2), !0;
  var t = e;
  try {
    X(this), (e = this);
...
function _i(t) {
  ...
  Y(this), (e = t), (this.f &= -2), 8 & this.f && q(this), E();
}
function l(t) {
  (this.x = t),
    (this.u = void 0),
...
l.prototype.S = function () {
  1 & this.f && x(), (this.f |= 1), (this.f &= -9), ii(this), X(this), h++;
  var t = e;
  return (e = this), _i.bind(this, t);
};
...
function ti(t) {
  ...
  var f = H(function () {
    ...
    return (
      (i.__$u.c = function () {
        var _;
        !ni(f.peek()) && ((_ = i.base) == null ? void 0 : _.nodeType) === 3
          ? (i.base.data = f.peek())
          : ((i.__$f |= 1), i.setState({}));
      }),
      Z(function () {
...
ri.prototype.shouldComponentUpdate = function (t, i) {
  var n = this.__$u;
