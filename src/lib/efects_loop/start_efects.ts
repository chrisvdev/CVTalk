 ...
 * 2. Efectos condicionales basados en propiedades: PatoBotTribute, muteBots, muteCommandsByPrefix, muteReplays
...
export default function startEfects(efectsLoop: EfectsLoop) {
  const { mute_bots, pato_bot, mute_prefixes, mute_replays } = window.OBSChat.properties || {}
